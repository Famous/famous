...
test('Quaternion', function(t) {
    ...
    t.test('put method', function(t) {
       ...
       var updated = {w: Math.PI*0.5, x: 8, y: 1, z: 3};
       ...
       var mutableQuaterion = new Quaternion();
       t.equal(quaternion.put(mutableQuaterion), mutableQuaterion);
       t.deepEqual(quaternion, original);
    });
